...
import net.malfact.bgmanager.api.event.FlagCaptureEvent;
import net.malfact.bgmanager.api.event.FlagDespawnEvent;
import net.malfact.bgmanager.api.event.FlagSpawnEvent;
